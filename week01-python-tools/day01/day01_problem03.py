#the problem :
#Before there were emoji, there were emoticons, whereby text like :) was a happy face and text like :( was a sad face. Nowadays,
...
def convert(the_sentence):
    converted_sentence=the_sentence.replace(":)","🙂").replace(":(","🙁")
